...
namespace NewsMix.Migrations
{
    ...
    [Migration("20240227151913_audit_fields")]
    partial class audit_fields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NewsMix.Storage.Entities.NewsTopic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            InternalName = "wow_classic_series",
                            NewsSource = "wowhead",
                            OrderInList = (byte)3,
